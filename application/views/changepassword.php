                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default bootstrap-admin-no-table-panel">
                                <div class="panel-heading">
                                    <div class="text-muted bootstrap-admin-box-title">Ganti Password</div>
                                </div>
                                <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                                    <div id="rootwizard">
                                        <div class="tab-content">
                                            <div class="tab-paned" id="tab1x">
                                                <form class="form-horizontal" action="/main/changepasswordhandler" method="post">
                                                    <fieldset>
                                                        <div class="form-group">
                                                            <label class="col-lg-4 control-label" for="focusedInput2">Password</label>
                                                            <div class="col-lg-8">
                                                                <input class="form-control" id="password1" name="password1" type="password" value="">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-lg-4 control-label" for="focusedInput3">Konfirmasi Password</label>
                                                            <div class="col-lg-8">
                                                                <input class="form-control" id="password2" name="password2" type="password" value="">
                                                            </div>
                                                        </div>
                                                    </fieldset>
                                                    <button class="btn" name="save" type="submit">Simpan</button>
                                                    <button class="btn" name="cancel" >Batalkan</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
